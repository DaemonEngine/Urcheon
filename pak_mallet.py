...
def main():
	...
	args.add_argument("-g", "--game-profile", dest="game_profile", metavar="FILENAME", default="unvanquished", help="use game profile %(metavar)s, default: %(default)s")
	args.add_argument("-id", "--input-pk3dir", dest="input_pk3dir", metavar="FILENAME", default=".", help="build from directory %(metavar)s, default: %(default)s")
	args.add_argument("-pd", "--output-prefix-pk3dir", dest="output_prefix_pk3dir", metavar="FILENAME", default="build" + os.path.sep + "test", help="build pk3dir in directory %(metavar)s, default: %(default)s")
	args.add_argument("-pp", "--output-prefix-pk3", dest="output_prefix_pk3", metavar="FILENAME", default="build" + os.path.sep + "pkg", help="build pk3 in directory %(metavar)s, default: %(default)s")
	args.add_argument("-od", "--output-pk3dir", dest="output_pk3dir", metavar="FILENAME", help="build pk3dir as directory %(metavar)s")
